...
grid <- readOGR('/TooBigData/grid100Utrecht.gpkg')
...
#Modelpredictions
modelPredictions <- read.csv('/TooBigData/SpatialPredictionPatterns/Predicting NO2-AllModelsUtrecht100_xy.csv')
...
#export option
sf::st_write(Hamburg_NO2PredictionPerModel, dsn='/TooBigData/Grid100/Utrecht_NO2PredictionPerModel.gpkg', driver = "GPKG")
