...
grid100_utrecht_csv = config_06.input_data['grid100_utrecht_csv']
...
#export to .xlsx & .csv
df_test_xy_XGB.to_excel(output_map_excel+'Predicting NO2-AllModels'+ str(city)+'_xy.xlsx')
df_test_xy_XGB.to_csv(output_map+'Predicting NO2-AllModels'+ str(city)+'_xy.csv')