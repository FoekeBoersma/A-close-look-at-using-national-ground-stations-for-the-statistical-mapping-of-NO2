...
grid <- readOGR('/Grid100/Hamburg/AOI/grid100HH.gpkg')
...
rastlist <- list.files(path = "/Grid100/Hamburg/TIFFS/1", pattern='.TIF$', all.files=TRUE, full.names=FALSE)

#define current working directory
setwd("/Grid100/Hamburg/TIFFS/1")
...
dis <- readOGR('/Grid100/Hamburg/AOI/DIS_BuildingDensity_HH.shp')
...
## == export options == ##
#shp - cen
sf::st_write(Cen100_GlobalPredictors, dsn="/Grid100/Hamburg/Cen100_GlobalPredictors-HH.gpkg", driver = "GPKG")
#shp - grid
sf::st_write(Grid100_GlobalPredictors, dsn="/Grid100/Hamburg/Grid100_GlobalPredictors-HH.gpkg", driver = "GPKG")

#csv
write.csv(Cen100_GlobalPredictors_wgs, '/Grid100/Hamburg/grid100_GlobalPredictors-HH.csv')
