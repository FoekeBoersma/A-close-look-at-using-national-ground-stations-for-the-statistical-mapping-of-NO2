...
grid <- readOGR('/TooBigData/grid100Hamburg.gpkg')
...
#Modelpredictions
modelPredictions <- read.csv('/TooBigData/SpatialPredictionPatterns/Predicting NO2-AllModelsHamburg100_xy.csv')
...
#export option
sf::st_write(Hamburg_NO2PredictionPerModel, dsn='/TooBigData/Grid100/Hamburg_NO2PredictionPerModel.gpkg', driver = "GPKG")
