...
grid <- readOGR('/Grid100/Bayreuth/AOI/grid100Bayreuth.gpkg')
...
rastlist <- list.files(path = "/Grid100/Bayreuth/TIFFS/8", pattern='.TIF$', all.files=TRUE, full.names=FALSE)

#define current working directory
setwd("/Grid100/Bayreuth/TIFFS/8")
...
dis <- readOGR('/Grid100/Bayreuth/AOI/DIS_BuildingDensity_Bayreuth.shp')
...
sf::st_write(datasets_sf, dsn="/Grid100/Bayreuth/datasets_sf.gpkg", driver = "GPKG")
...
## == export options == ##
#shp - cen
sf::st_write(Cen100_GlobalPredictors, dsn="/Grid100/Bayreuth/Cen100_GlobalPredictors-Bayreuth.gpkg", driver = "GPKG")
#shp - grid
sf::st_write(Grid100_GlobalPredictors, dsn="/Grid100/Bayreuth/Grid100_GlobalPredictors-Bayreuth.gpkg", driver = "GPKG")

#csv
write.csv(Cen100_GlobalPredictors_wgs, '/Grid100/Bayreuth/grid100_GlobalPredictors-Bayreuth.csv')
