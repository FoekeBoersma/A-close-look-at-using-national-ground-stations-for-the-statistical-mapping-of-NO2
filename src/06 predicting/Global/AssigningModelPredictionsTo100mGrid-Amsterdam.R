...
#Modelpredictions
modelPredictions <- read.csv('/TooBigData/SpatialPredictionPatterns/Predicting NO2-AllModelsAmsterdam100_xy.csv')
...
#export option
sf::st_write(Amsterdam_NO2PredictionPerModel, dsn='/TooBigData/Grid100/Amsterdam_NO2PredictionPerModel.gpkg', driver = "GPKG")
