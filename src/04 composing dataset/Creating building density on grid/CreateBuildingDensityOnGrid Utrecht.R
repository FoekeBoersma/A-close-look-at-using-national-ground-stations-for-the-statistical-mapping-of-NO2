...
# Calculate the area of each 100m buffer (circle area = pi * r^2)
buffer_area <- pi * (100)^2  # Area of the 100m radius buffer

# Calculate building density (total building area / buffer area) and assign it to the grid centroids
...
output_shapefile_path <- file.path(out_location_dir, 'grid_bldden_100m_utrecht.shp')
