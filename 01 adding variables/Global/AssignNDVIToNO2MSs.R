...
ms <- read.csv("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/glo4var_2021.csv", sep = ";")
...
#export option
sf::st_write(points_NDVI, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/tifs/NDVI/shp", layer='ms_NDVI', driver = "ESRI Shapefile")
