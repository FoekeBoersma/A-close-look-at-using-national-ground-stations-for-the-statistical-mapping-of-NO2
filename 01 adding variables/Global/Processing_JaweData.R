...
trafGER <- read.csv('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/tifs/Traffic/Jawe2017.csv', sep = ';')
...
sf::st_write(Jawe_processed_sf, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Traffic_May2022/ARCGIS/MyProject22',layer='Jawe_processed', driver = "ESRI Shapefile")

#csv
write.csv(Jawe_processed, 'C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Traffic_May2022/Germany/Jawe_processed.csv')
