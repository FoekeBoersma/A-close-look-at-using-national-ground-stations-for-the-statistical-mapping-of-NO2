...
for(i in bufs){
  ...
  sf::st_write(buf_i, dsn='C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity',layer=layer, driver = "ESRI Shapefile")
...
#export option
#sf::st_write(buildings_utm, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer='buildings_32', driver = "ESRI Shapefile")
...
while(j <= length(buffer_vars)){
  ...
  clip <- st_as_sf(clip)
  #export option
  sf::st_write(clip, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer=layer_clip, driver = "ESRI Shapefile")
  ...
  print(layer_int)
  sf::st_write(int_j, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer=layer_int, driver = "ESRI Shapefile")
  ...
  #export option
  sf::st_write(dis, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer=layer_dis, driver = "ESRI Shapefile")
  ...
  #export option
  sf::st_write(merge, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer=layer_mer, driver = "ESRI Shapefile")
...
#export option
sf::st_write(ms_bldden_per_buf, dsn="C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-Local/BuildingDensity", layer='BldDen_ms_StudyArea', driver = "ESRI Shapefile")
