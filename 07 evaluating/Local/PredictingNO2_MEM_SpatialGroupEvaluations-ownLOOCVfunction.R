...
data_3035_sel = data_3035[,c("population_1000", "dist", "road_class_1_100", "road_class_2_100", "road_class_3_100", "spachar", "Lopend_gemiddelde")]
...
## create function that performs leave-one-out cross-validation using input database (data_df)
