...
global_RF <- global_df$p_NO2_RF
global_xgboost <- global_df$p_NO2_X
global_lightgbm <- global_df$p_NO2_LG
global_lasso <- global_df$p_NO2_LA
global_ridge <- global_df$p_NO2_RI
...
#local
linear = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_Linear.gpkg")
linear_separated = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_Linear_SeparatingSpatialGroups_1.gpkg")
MEM = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_MEM.gpkg")
UK = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_UK_formula.gpkg")
UK_separated = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_UK_SeparatingSpatialGroups.gpkg")
OK = readOGR("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/predictedNO2_OK.gpkg")
...
#to excel
write_xlsx(local_df, "C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels - Predicting/Local_df.xlsx")

## == export option == ##
#sf::st_write(local_sf, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/local_predictions.gpkg", driver = "GPKG")
...
#NO2tif
NO2tif <- ('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels - Predicting/NO2.tif')
...
## == export option == ##
sf::st_write(local_and_no2tif_grid, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/local_and_no2tif_grid.gpkg", driver = "GPKG")

global_sf <- st_as_sf(global)
all_models <- st_join(local_and_no2tif_grid, global_sf, largest = T, left = T)

## == export option == ##
sf::st_write(all_models, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/LocalModels/all_models.gpkg", driver = "GPKG")
