...
#krige_ok <- krige.cv(Lopend_gemiddelde ~ 1 + nightlight_450 + nightlight_4950 + population_3000 + road_class_1_5000 + road_class_2_1000 + road_class_2_5000 + road_class_3_100 + road_class_3_300 + trafBuf50, data_sp, m)
# leave-one-out cross validation - exclusion of predictors:
...
#merge the kriging output with the initial dataframe
