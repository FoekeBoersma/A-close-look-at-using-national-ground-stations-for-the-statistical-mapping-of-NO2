...
class(poly_sf)
sf::st_write(poly_sf, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/AOI/polyBayreuth.gpkg', driver = "GPKG")
...
#export option
sf::st_write(grid, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/AOI/grid100Bayreuth.gpkg', driver = "GPKG")
