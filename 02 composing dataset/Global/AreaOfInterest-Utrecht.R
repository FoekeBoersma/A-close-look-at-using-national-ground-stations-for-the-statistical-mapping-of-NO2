...
class(poly_sf)
sf::st_write(poly_sf, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Utrecht/AOI/polyUtrecht.gpkg', driver = "GPKG")
...
#export option
sf::st_write(grid, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Utrecht/AOI/grid100Utrecht.gpkg', driver = "GPKG")
