...
#Modelpredictions
modelPredictions <- read.csv('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/Predicting NO2-AllModelsBayreuth100_xy.csv')
...
#export option
sf::st_write(Bayreuth_NO2PredictionPerModel, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/Bayreuth_NO2PredictionPerModel.gpkg', driver = "GPKG")
