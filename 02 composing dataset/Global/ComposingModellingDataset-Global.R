...
spdf_nodata <- spdf_ms_stations[,("M_id")]
...
colnames(prec)
prec <- prec %>% select(-contains("coords"))
...
buildingdensity_ms <- readOGR('C:/Users/foeke/OneDrive/Documenten/ArcGIS/Projects/MyProject22-BuildingDensity/BldDen_ms_StudyArea.shp')
#make spatial
buildingdensity_ms_sf <- st_as_sf(buildingdensity_ms)


#to perform spatial join, crs's of input data need to be equal
buildingdensity_ms_sf <- st_transform(buildingdensity_ms_sf, crs=crs)
prec = st_transform <- st_transform(prec, crs=crs)
...
#import NDVI data
NDVI_ms <- readOGR('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/tifs/NDVI/shp/ms_NDVI.shp')
#examine
#view(NDVI_ms)
...
trafficvolume_ms <- readOGR('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Traffic_May2022/ARCGIS/MyProject22/Traffic_StudyArea.shp')
#make spatial
...
ms_prec_bd_ndvi_traf <- subset(ms_prec_bd_ndvi_traf, select = -c(Vierweekse_1, Vierweekse_2 ,Vierweekse_3,Vierweekse_4,Vierweekse_5,Vierweekse_6,Vierweekse_7,Vierweekse_8,Vierweekse_9,Vierweekse_10,Vierweekse_11,Vierweekse_12,Vierweekse_13,Locatie, X, CodeW,Jaar,
                                                                 Type_meetpunt, Meting_op_wettelijke_toetsafstand, Type_meting, Opmerkingen) )
...
#export options
#shapefile
# sf::st_write(ms_prec_bd_ndvi_traf, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForModelling", layer='ForModelling_Global', driver = "ESRI Shapefile")
# #csv
# write.csv(ms_prec_bd_ndvi_traf, 'C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForModelling/ForModelling-Global.csv',col.names = TRUE)
