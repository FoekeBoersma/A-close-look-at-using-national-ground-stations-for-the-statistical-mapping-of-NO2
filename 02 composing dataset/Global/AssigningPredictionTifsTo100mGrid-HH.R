...
#Modelpredictions
modelPredictions <- read.csv('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Hamburg/Predicting NO2-AllModelsHamburg100_xy.csv')
...
#export option
sf::st_write(Hamburg_NO2PredictionPerModel, dsn='C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Hamburg/Hamburg_NO2PredictionPerModel.gpkg', driver = "GPKG")
