...
grid <- readOGR('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/AOI/grid100Bayreuth.gpkg')
...
print(grid_centroids_32)

## == PREDICTORS 5 (AMSTERDAM) GLOBAL DATASET == ##

#first import all files in a single folder as a list 
rastlist <- list.files(path = "C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/TIFFS/8", pattern='.TIF$', all.files=TRUE, full.names=FALSE)

#define current working directory
setwd("C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/TIFFS/8")
...
dis <- readOGR('C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/AOI/DIS_BuildingDensity_Bayreuth.shp')
...
#loop
for(i in bufs){
  buf_i <- st_buffer(grid_centroids_32, i)
...
datasets <- merge(datasets, grid_centroids_32, by= "cenID")
print(datasets)

datasets_sf <- st_as_sf(datasets, crs=crs_32)

sf::st_write(datasets_sf, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/datasets_sf.gpkg", driver = "GPKG")
...
#Centroids
Cen100_GlobalPredictors <- st_join(grid_centroids_32, datasets_sf, join=st_nearest_feature)

Cen100_GlobalPredictors[is.na(Cen100_GlobalPredictors)]<- 0

print(Cen100_GlobalPredictors)
...
Grid100_GlobalPredictors <- st_join(grid_32, datasets_sf, join=st_nearest_feature)
#remove NA's and change to 0
...
## == export options == ##
#shp - cen
sf::st_write(Cen100_GlobalPredictors, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/Cen100_GlobalPredictors-Bayreuth.gpkg", driver = "GPKG")
#shp - grid
sf::st_write(Grid100_GlobalPredictors, dsn="C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/Grid100_GlobalPredictors-Bayreuth.gpkg", driver = "GPKG")

#csv
write.csv(Cen100_GlobalPredictors_wgs, 'C:/Users/foeke/OneDrive/Documenten/april onwards/2022/Initial dataset/ForPredicting/Grid100/Bayreuth/grid100_GlobalPredictors-Bayreuth.csv')
